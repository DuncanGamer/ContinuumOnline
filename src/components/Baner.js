...
function Baner() {
    return (
        <>
            <div className="mt-44 pt-10-2 bg-gradient-to-r from-cyan-500 to-blue-500y">
                <div className="container w-full flex items-center mx-auto  text-white py-32 px-16 " >
                    <div className="w-1/2">
                        <h2 className=" font-bold text-6xl "> Star Rocking Today</h2>
                        <p className=" text-lg font-medium mt-4"> Sing UP now and you'll be up in just minuts</p>
                    </div>
            ...
            <div className="container mx-auto pb-32 pt-32">
                <section className="mb-10 text-gray-700">
                    <div className="container relative snap-x overflow-x-auto mx-auto flex md:grid-cols-3 gap-6 lg:gap-12 text-center">
                        <div className=" px-4 container mx-auto shrink-0 md:shrink mb-12 md:mb-0">
                            ...
                            <ul className="flex justify-center mb-0">
                                <li>
                                    <svg data-icon="star" className="w-4 text-yellow-500" viewBox="0 0 576 512">
                                        <path fill="currentColor"
                        ...
                        <div className="px-4 container mx-auto shrink-0 md:shrink mb-0">
                            <div className="flex justify-center mb-6">
